 ...
 * 2024-09-27T23:12:52.208-03:00
 * Generated source version: 4.0.5
 *
 */
@WebServiceClient(name = "ServicoCalculadora",
                  wsdlLocation = "file:/home/delalibera/app/calculadora-quarkus/src/main/resources/ServicoCalculadora.wsdl",
...
public class ServicoCalculadora extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:/home/delalibera/app/calculadora-quarkus/src/main/resources/ServicoCalculadora.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServicoCalculadora.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/delalibera/app/calculadora-quarkus/src/main/resources/ServicoCalculadora.wsdl");
        }
        WSDL_LOCATION = url;
    }
